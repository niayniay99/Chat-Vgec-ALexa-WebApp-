...
<title>AI based Banking | Add Event</title>
<!-- plugins:css -->
<link rel="stylesheet"
							...
							<div class="card">
								<div class="card-body">
									...
									<f:form class="cmxform" id="commentForm" method="post"
										onsubmit="return addEventtype()" action="saveEventtype" modelAttribute="EventtypeVO">
										<fieldset>
											<div class="form-group">
												<label for="cname">Event Name</label>
												<f:input id="eventName" class="form-control" name="eventName"
													type="text" path="eventName" onkeypress='return event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122 || event.charCode==32' />
											</div>

											<div class="form-group">
												<label for="ccomment">Event Description</label>
												<f:textarea id="eventDescription" class="form-control"
													path="eventDescription" name="eventDescription"></f:textarea>
											</div>
											<f:hidden path="eventtypeid" />
