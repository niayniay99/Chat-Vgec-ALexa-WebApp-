...
<title>AI based Banking | Add Form</title>
<!-- plugins:css -->
<link rel="stylesheet"
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<f:form class="cmxform" id="signupForm" method="post" action="saveForm" modelAttribute="FormVO" onsubmit="return addForm()" enctype="multipart/form-data">
										<fieldset>
											...
											<div class="form-group">
												...
												<f:input id="fileName" class="form-control" name="fileName"
													type="text" path="fileName" />
											</div>
